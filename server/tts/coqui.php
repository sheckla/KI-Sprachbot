...
$text = preg_replace("/[.!?]/u", "\n", $text);
$text = str_replace('KI','K-I-', $text);
$text = str_replace('twi-bot','twaybott', $text);
$text = str_replace('cybob','Tsei-Bob', $text);
...
$ch = curl_init("http://127.0.0.1:". $port . "/v1/audio/speech");
