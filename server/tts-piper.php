...
$modelQuality = "medium";
$MODEL_ONNX = '../voices/de_DE-' . $modelName . "-" . $modelQuality . ".onnx";
...
// clip fix
$text = $text . ".!_! !_! !_! !_! !_! !_! !_! !_! !_! !_! !_! !_! !_! .!_! !_! !_! !_! !_! !_! !_! !_! !_! !_! !_! !_! !_! .!_! !_! !_! !_! !_! !_! !_! !_! !_! !_! !_! !_! !_!";
...
$parts = [
  ...
  '--sentence-silence ', escapeshellarg("0.9"),
  "--speaker " . $emotion,
  "--length-scale " . $speed,
